package com.social.qa.service;

import com.social.qa.dao.ProblemDao;
...
public class ProblemService {
     ...
     * @return
     */
    public Page<Problem> findNewReplyList(String labelid, int page, int size){
        //1.创建分页对象
        Pageable pageable = PageRequest.of(page - 1, size);
        //2.调用持久层查询，并返回
        return problemDao.findNewReplyList(labelid, pageable);
    }
     ...
     * @return
     */
    public Page<Problem> findHotReplyList(String labelid, int size, int page){
        //1.创建分页对象
        Pageable pageable = PageRequest.of(page - 1, size);
        //2.调用持久层查询，并返回
        return problemDao.findHotReplyList(labelid, pageable);
    }
